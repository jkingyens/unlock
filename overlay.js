...
function createOverlay() {
    // Prevent creating the overlay multiple times
    if (document.getElementById('unlock-media-overlay')) {
        return;
    }

    // Add an inline style to prevent the initial flicker
    // This forces the element to be invisible until the script confirms its state.
...
// This solves the race condition where the background sends a message before this script is listening.
