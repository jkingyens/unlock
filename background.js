...
// SIMPLIFIED: This function now just links existing tabs in existing groups at startup.
// The complex logic of finding matches is now handled by the navigation-handler.
async function restoreContextOnStartup() {
    logger.log('Background:restoreContext', 'Starting context restoration...');
    if (!(await shouldUseTabGroups())) {
